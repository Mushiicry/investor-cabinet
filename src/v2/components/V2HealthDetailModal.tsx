...
const WHAT: Record<HealthComponentKey, string> = {
  ...
  concentration:
    "Концентрация — контроль лимитов отдельных активов. Внутри крипто-блока: ETH 35%, BTC 20%, SOL/TON/BNB 10%, альткоины 5%. Под альткоины есть только 3 места по 5%. Для акций и металлов один актив не должен быть выше 35% портфеля. Балл = системный риск крупнейшей позиции минус штраф за активы сверх лимита.",
  diversification:
...
const HOW: Record<HealthComponentKey, string[]> = {
  ...
  concentration: [
    ...
    "Крипто-лимиты внутри блока: ETH 35% · BTC 20% · SOL/TON/BNB 10% · альты 5% · максимум 3 альта",
