...
export const decisionsData: Decision[] = [
  ...
  { asset: "ATOM", thesis: "Серьёзный гик-проект с настоящими разработчиками. График в сильной зоне перепроданности.", whyHold: "Cosmos переживёт мем-хайп и фан-проекты. Сложная но живая экосистема. Держу небольшой объём, стейкаю прямо в кошельке.", expect: "Рост медленный. Актив нишевый — без хайпа, без массовой аудитории. Риск: сложность никому не нужна.", nextAction: "Загружать небольшими объёмами. Докупать ступенями только при просадке более 30%.", reviewTrigger: "Уход разработчиков, падение TVL до нуля, отсутствие обновлений.", status: "Накапливать" },
  { asset: "GOLD LONG", thesis: "Защита капитала при неопределённости. Верю в продолжение долгосрочного роста золота.", whyHold: "При медвежьей фазе в крипте и экономической нестабильности перехожу в золото. Не выхожу в стейблы полностью — золото работает как система накопления богатства и приносит прибыль.", expect: "Спокойное восходящее движение с паузами. Без взрывной доходности, но устойчиво вверх.", nextAction: "Докупать при любых просадках. Продавать частями только от $5 000+.", reviewTrigger: "Смена макро-режима на устойчивый risk-on. Изменение общей защитной логики портфеля.", status: "Хедж" },
...
export const scenariosData: ScenarioCard[] = [
  ...
  { asset: "ATOM", base: "Боковик или медленный рост. Экосистема продолжает развиваться без хайпа.", bull: "Внимание к Cosmos возвращается. Перепроданность закрывается — быстрое движение вверх.", bear: "Сложность экосистемы отпугивает массового пользователя. Долгая стагнация без объёмов.", action: "Покупать ступенями при просадках от 30%. Стейкать в кошельке для пассивного дохода.", invalidation: "Массовый исход разработчиков или закрытие ключевых проектов в экосистеме.", status: "Наблюдение" },
  { asset: "GOLD LONG", base: "Спокойное восходящее движение. Защитный спрос поддерживает цену при любой волатильности в экономике.", bull: "Рост на волне страха: экономическая нестабильность, геополитика, медвежья фаза в крипте — золото выигрывает.", bear: "Risk-on. Рынки растут, крипта на хайпе — золото стоит на месте или немного снижается.", action: "Докупать при любых просадках без ограничений. Продавать частями только от $5 000+.", invalidation: "Устойчивый переход в risk-on без возврата к защитным активам. Смена роли золота в портфеле.", status: "Хедж" },
