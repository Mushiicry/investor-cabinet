...
- Cosmos wallet balance and staking normalization;
...
- public Cosmos wallet address `cosmos19cykvjv5sqgqgrrw0n94et2knvj3t3chpv7hka`;
...
- Apps Script read-only Cosmos wallet balance import;
- Sheets `Транзакции_IMPORT`;
- Sheets `TON_WALLETS`.
- Sheets `EVM_WALLETS`.
- Sheets `SOLANA_WALLETS`.
- Sheets `COSMOS_WALLETS`.
